...
namespace Validations
{
    ...
    public sealed class RequiredIfAttribute : ValidationAttribute
    {
        ...
        public RequiredIfAttribute(string otherProperty, object otherPropertyValue, bool isInverted = false)
            : base("'{0}' es requerido porque '{1}' tiene un valor {3}'{2}'.")
        {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (otherProperty == null)
            {
                return new ValidationResult(
                    string.Format("No se puede encontrar la propiedad llamada '{0}'.", this.OtherProperty));
            }
